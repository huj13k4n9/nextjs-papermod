        ...
        <div className={`relative group max-w-4xl`}>
            ...
            >
                <AnimatePresence mode="wait">
                    {copied ? (
                        <motion.div className={`px-2 py-2 w-10 h-10 [&>*]:w-5 [&>*]:h-5 flex items-center justify-center`} key="check" {...animationParams}>
                            <LuCheckCheck />
                        </motion.div>
                    ) : (
                        <motion.div className={`px-2 py-2 w-10 h-10 [&>*]:w-5 [&>*]:h-5 flex items-center justify-center`} key="copy" {...animationParams}>
                            <LuCopy />
                        </motion.div>
                    )}
                </AnimatePresence>
